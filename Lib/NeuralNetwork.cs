...
namespace EVN.Lib
{
    class NeuralNetwork<T> where T: IComparable<T>
    {
        ...
        public delegate void IterationChangedCallBack(object o, BPBase.NeuralEventArgs args);
        ...
        public bool Train()
        {
            ...
            BPBase.NeuralEventArgs Args = new BPBase.NeuralEventArgs();
